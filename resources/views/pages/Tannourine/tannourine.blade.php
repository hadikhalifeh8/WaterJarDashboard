...
@section('title')
    {{ trans('sereptaTransl.Tannourine_List') }} 
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">  {{ trans('sereptaTransl.Tannourine_List') }}</h4>
        </div>
    </div>
</div>
@endsection
                    ...
                    <tbody>
                        ...
                        @foreach ($tannourine as $V_tannourine)
                            <tr>
                                ...
                                <td>{{ $i }}</td>
                                <td>{{$V_tannourine->name}}</td>
                                <td>{{$V_tannourine->price_Lira}}</td>
                                <td>{{$V_tannourine->price_Dollar}}</td>

                                
                                <td>
                                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                        data-target="#edit{{$V_tannourine->id}}"
                                        title="{{ trans('sereptaTransl.edit') }}"><i class="fa fa-edit"></i></button>
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                        data-target="#delete{{$V_tannourine->id}}"
                            ...
                            <!-- edit_modal_Grade -->
                            <div class="modal fade" id="edit{{$V_tannourine->id}}" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <input id="text" type="text" name="name_ar"
                                                               class="form-control"
                                                               value="{{$V_tannourine->getTranslation('name','ar')}}"
                                                               required>
                                                        <input id="id" type="hidden" name="id" class="form-control"
                                                               value="{{$V_tannourine->id}}">
                                                    </div>
                                                    <div class="col">
                                                        <label for="Name"
                                                        ...
                                                        <input type="text" class="form-control"
                                                               value="{{$V_tannourine->getTranslation('name','en')}}" 
                                            ...
                                            <label for="Name"
                                                ...
                                                :</label>
                                            <input class="form-control" value="{{$V_tannourine->price_Lira}}" type="number" min="0" name="price_Lira" required onkeypress="return restrictChars(event)" />
                                        </div>
                                        ...
                                        <div class="col">
                                            <label for="Name"
                                                ...
                                                :</label>
                                            <input class="form-control"  value="{{$V_tannourine->price_Dollar}}" step="0.1" type="number" min="0" name="price_Dollar" required onkeypress="return restrictChars(event)" />
                                        </div>
                            ...
                            <!-- delete_modal_Grade -->
                            <div class="modal fade" id="delete{{$V_tannourine->id}}" tabindex="-1" role="dialog"
                                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title"
                                                id="exampleModalLabel">
                                                {{ trans('sereptaTransl.delete_product') }} : {{$V_tannourine->name}}
                                            </h5>
                                            <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                        ...
                                        <div class="modal-body">
                                            <form action="{{route('Tannourine.destroy', 'test')}}"
                                                  method="post">
                                                {{ method_field('Delete') }}
                                                @csrf
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class=" row mb-30" action="{{route('Tannourine.store')}}" method="POST">
                    @csrf
                    <div class="card-body">
                        <div class="repeater">
                            <div data-repeater-list="List_Tannourine">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <label for="Name"
                                                class="mr-sm-2">{{ trans('sereptaTransl.price_dollar') }}
                                                :</label>
                                            <input class="form-control" type="number" step="any" min="0" name="price_Dollar"
